...
\begin{figure}[htbp]
\centering
\includegraphics[width=\columnwidth]{figures/output_score_reward.png}
\caption{Output-data trend plot: average score and average total reward improve across iterative rounds.}
\label{fig:output_score_reward}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=\columnwidth]{figures/output_task_reward.png}
\caption{Task-level total reward progression across iterative rounds (output data only).}
\label{fig:output_task_reward}
\end{figure}
