...
\begin{figure}[htbp]
\centering
\includegraphics[width=\columnwidth]{figures/round_trends.png}
\caption{Round-level trends show steady score/reward improvement, while success rate stays flat under strict terminal thresholds.}
\label{fig:round_trends}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=\columnwidth]{figures/task_progression.png}
\caption{Per-task progression across rounds. Medium and hard tasks show stronger reward/score movement than easy.}
\label{fig:task_progression}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=\columnwidth]{figures/risk_vs_threshold.png}
\caption{Observed final highest collision probability versus success thresholds in the best round. Threshold gaps explain persistent zero success.}
